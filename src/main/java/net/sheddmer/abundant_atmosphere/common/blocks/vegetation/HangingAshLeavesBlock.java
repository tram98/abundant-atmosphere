package net.sheddmer.abundant_atmosphere.common.blocks.vegetation;
...
public class HangingAshLeavesBlock extends Block implements IForgeShearable {
    ...
    public HangingAshLeavesBlock(Block.Properties properties) {
        super(properties);
    }
