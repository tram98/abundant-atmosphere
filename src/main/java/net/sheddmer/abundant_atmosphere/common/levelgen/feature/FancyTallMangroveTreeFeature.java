...
import net.sheddmer.abundant_atmosphere.common.levelgen.treedecorator.MangroveFancyTrunkPlacer;
import net.sheddmer.abundant_atmosphere.common.levelgen.treedecorator.PoreshroomDecorator;
...
public class FancyTallMangroveTreeFeature {
    private static final BeehiveDecorator BEEHIVE_001 = new BeehiveDecorator(0.01F);

    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> FANCY_TALL_MANGROVE_TREE = FeatureUtils.register("fancy_tall_mangrove_tree", Feature.TREE,
            (new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.MANGROVE_LOG),
                    new MangroveFancyTrunkPlacer(6, 6, 9), BlockStateProvider.simple(Blocks.MANGROVE_LEAVES),
                    ...
                    new MangroveRootPlacement(Registry.BLOCK.getOrCreateTag(BlockTags.MANGROVE_ROOTS_CAN_GROW_THROUGH), HolderSet.direct(Block::builtInRegistryHolder, Blocks.MUD, Blocks.MUDDY_MANGROVE_ROOTS), BlockStateProvider.simple(Blocks.MUDDY_MANGROVE_ROOTS), 10, 15, 0.2F))),
                    new TwoLayersFeatureSize(2, 0, 2))).decorators(List.of(new LeaveVineDecorator(0.125F), new PoreshroomDecorator(0.5F),
